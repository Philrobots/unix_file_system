...
private:
	...
	iNode get_iNode();
	void simuleBitMapBlocLibre(); // pour simuler le bitmap des blocs libres ( rajoutés )
	void simuleBitMapINodeLibre(); // pour simuler le bitmap des i-nodes libres ( rajoutés )
	void simulateMetadonne(); // pour simuler metadonne ( rajoutés )
	void simulateListeRepertoire(); // pour simuler listes de répertoires ( rajoutés )
};
